...
QT_MOC_LITERAL(1, 12, 11), // "setNewLight"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 4), // "Type"
QT_MOC_LITERAL(4, 30, 4) // "type"

    },
    "LightWidget\0setNewLight\0\0Type\0type"
};
...
void LightWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { int _r = _t->setNewLight((*reinterpret_cast< Type(*)>(_a[1])));
        ...
        {
            typedef int (LightWidget::*_t)(Type );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LightWidget::setNewLight)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
int LightWidget::setNewLight(Type _t1)
{
    int _t0 = int();
